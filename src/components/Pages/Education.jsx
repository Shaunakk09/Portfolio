...
export const Education = ({ theme }) => {
  return (
    <div id="education" className={`ml-0 mr-0 mb-5 sm:ml-20 sm:mr-20 sm:mb-20 max-w-full rounded-lg shadow flex flex-col`} style={{ backgroundImage: `url(./icons/background/${theme}/circle-scatter.svg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className='ml-6 mb-3 sm:ml-8 sm:mb-5 flex flex-row items-center relative'>
            ...
            <div className='flex flex-row absolute top-5 -left-1'>
                ...
                <div className='flex flex-col relative -top-1'>
                    ...
                    <div className={`ml-5 sm:ml-6 text-xs sm:text-base font-bold tracking-tight ${theme === "darkMode" ? "text-gray-400" : "text-gray-700"}`}>B-Tech - CS</div>
                    <div className={`ml-5 sm:ml-6 text-xs sm:text-base font-bold tracking-tight ${theme === "darkMode" ? "text-gray-400" : "text-gray-700"}`}>CGPA - 8.00/10</div>
                </div>
            </div>
