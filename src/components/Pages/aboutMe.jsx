  ...
  return (
    <div id="about-me" className={`ml-0 mr-0 mb-5 sm:ml-20 sm:mr-20 sm:mb-20 max-w-full bg-[${theme === "darkMode"? "#1f2937": "#feffff"}] rounded-lg shadow flex flex-col items-center sm:items-start sm:flex-row`}>
        ...
        <div className='py-3 sm:pt-5 flex flex-col items-center sm:items-start'>
            ...
            <h5 className={`ml-4 mr-2 mb-3 sm:ml-0 font-normal ${theme === "darkMode" ? "text-gray-400" : "text-gray-700"}`}>Thriving in collaborative spaces, I'm energized by the prospect of learning new technologies and staying ahead of industry trends. My ultimate goal is not just proficiency but to be the innovative spark that propels software engineering forward. Let's connect and embark on a journey to bring innovation to life!</h5>
        </div>
    </div>
  )
}